...
import { AsignaturaInterfaz } from '../utils/AsignaturasInterfaz';
...
export class ServicioAsignaturasService {
  ...
  asignaturasArray: AsignaturaInterfaz[] = [
    {
  ...
  asignaturaFiltradas: AsignaturaInterfaz[] = [];

  getAllAsignatura(): AsignaturaInterfaz[] {
    return this.asignaturasArray;
  }

  getAsignaturasFiltradas(nombre: string,curso: number): AsignaturaInterfaz[] {
